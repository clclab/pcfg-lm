...
java -Xmx4g -cp src/data_generation/berkeley_parser/CustomBerkeley.jar edu.berkeley.nlp.PCFGLA.GrammarTrainer \
...
java -Xmx4g -cp src/data_generation/berkeley_parser/BerkeleyParser-1.5.jar edu.berkeley.nlp.PCFGLA.WriteGrammarToTextFile \
